/**
 * Normalize Philippine mobile numbers to M360 MSISDN: 639XXXXXXXXX (12 digits).
 */
export function normalizePhilippineMsisdn(phone) {
...
/** @returns {number|null} MSISDN as integer for M360 API */
export function normalizePhilippineMsisdnNumber(phone) {
